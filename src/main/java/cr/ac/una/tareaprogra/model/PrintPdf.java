...
public class PrintPdf {
    ...
    private String Regular = "cr/ac/una/practica/resources/Rancho-Regular.ttf";
    ...
    void fillDataPdf(Associate associate) throws IOException, DocumentException{
        id = associate.getId();
        name = associate.getName();
        invoice = associate.getInvoice();
        dateOfBirth = associate.getDateOfBirth();
        sex = associate.getSex();
        addressPhoto = associate.getAdressPhoto();
        printPdf();
    }
}